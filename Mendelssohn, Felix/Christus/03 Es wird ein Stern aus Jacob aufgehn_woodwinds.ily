...
nFlI = \relative c' {
  ...
  % S. 6
  \partCombineApart bes( es,) \partCombineAutomatic g( bes) | es( d) c2~ | c4 c( as c) | f( es)  d2~ | d4  b( c d) | es g f es |
  % S. 7
  ...
  % S. 20
  f g | as g | f1 | es\f~ | es4 r r2 | R1*3 | r4 \partCombineApart es\p( g bes) |
  % S. 21
  c4. c8( bes4  as) | bes es, \partCombineAutomatic es'2~ | es1~ | es~ | es~ | es4 es, g bes | es2 es | es1\fermata \bar "|."
}
...
nFlII = \relative c' {
  ...
  % S. 6
  \partCombineApart g( es) \partCombineAutomatic g( bes) | es( d) c2~ | c4 c( as c) | f( es)  d2 |  g,1~ | g2 c~ |
  % S. 7
  ...
  bes1\f | g | bes | g | as2\p g | f g | as\cresc g |
  % S. 20
  f g | as g | f1 | es\f~ | es4 r r2 | R1*3 | r4 \partCombineApart es2\p( g4) |
  % S. 21
  as4. as8( g4 as)  | g es \partCombineAutomatic es2~ | es1~ | es~ | es~ | es4 es2 g4 | g2 g | g1\fermata \bar "|."
}
...
nObI = \relative c' {
  ...
  % S. 15
  r4 es,\p( g) bes | c4.\cresc c8 bes4 as | bes2 es, | r4 \once \partCombineUnisono es\f g bes | c4. c8 bes4 a | \partCombineApart  es'( bes'\dim as g) |
  % S. 16
  g2( f) \partCombineAutomatic | es4\p es \partCombineChords g\cresc bes | c4. c8 bes4 a | \partCombineApart bes\f g f es | << d1 {s4 s2\dim s8 s\!} >> | es4 \partCombineUnisono bes2 as4 | g2 f |
  % S. 17
  es1\p~ | es2. r4 | \partCombineAutomatic R1*4 | r2 bes'\p | c\cresc d |
  % S. 18
  es d | c c | bes1\>~ | bes2.\! r4 | R1*4 |
  % S. 19
  bes1\f | g | bes | g | as2\p g | f g | as\cresc g |
  ...
  % S. 21
  R1 | r4 \partCombineApart es\p( g bes) | c4. c8( bes4 as) \partCombineAutomatic | bes2 es,~ | es2. es4 | g bes es2~ | es es | es1\fermata \bar "|." 
}
...
nObII = \relative c' {
  ...
  % S. 9
  d \once \partCombineApart bes bes2~ | bes1~ | bes4 bes bes bes | des2\sf des | r4 bes bes bes | des2\sf des |
  % S. 10
  r4 bes bes bes | bes2\sf bes | r4 ges ges ges | ges2 es | R1*2 |
  % S. 11
  r4 f\f f f | f4. f8 e4 e | f2 r | R1 | r4 f f f | f4.\sf f8 fes4 fes |
  ...
  % S. 15
  r4 es,2\p g4 | as2\cresc es | g es | r4 \once \partCombineUnisono es\f g bes | c4. c8 bes4 a | \partCombineApart es'(g\dim f es) |
  % S. 16
  es2( d) \partCombineAutomatic | es4\p es, \partCombineChords g\cresc bes | c4. c8 bes4 a | \partCombineApart bes2\f as4 g | as( c\dim bes as) | g \partCombineUnisono bes2 as4 | g2 f |
  % S. 17
  es1\p~ | es2. r4 | \partCombineAutomatic R1*4 | r2 bes'\p | c\cresc d |
  % S. 18
  es d | c c | bes1\>~ | bes2.\! r4 | R1*4 |
  ...
  f g | as g | f1 | es\f~ | es4 r r2 | R1*4 |
  % S. 21
  R1 | r4 \partCombineApart es\p( g bes) | as4. as8( g4 as) \partCombineAutomatic | g2 es~ | es2. es4 | g bes es2~ | es es | es1\fermata \bar "|." 
}
...
nKlarI = \transpose c bes \relative c' {
  ...
  % S. 6
  f4 r  a,( c) |  f( e) d2~ | d4 d( bes d) | g( f) e2~ | e4 cis( d e) | f a g f |
  % S. 7
  ...
  % S. 16
  c1 | f4\p \partCombineUnisono f, a\cresc c | d4. d8 c4 b | \partCombineAutomatic c\f a' g f | << e1 {s4 s2\dim s8 s\!} >> | f4 \partCombineUnisono c2 bes4 | a2 e |
  % S. 17
  f1\p~ | f2. r4 | \partCombineAutomatic R1*3 | c'1~\p | c2 c | d\cresc e |
  % S. 18
  f e | d d | c1\>~ | c2.\! r4 | R1*4 |
  % S. 19
  c1\f | a | c | a | bes2\p a | g a | bes\cresc a |
  % S. 20
  g a | bes a | g1 | f\f~ | f4 r r2 | R1*3 | r4 \partCombineApart f4\p( a c) |
  % S. 21
  d4. d8( c4 bes) | c \partCombineAutomatic f,2.~ | f4 \partCombineApart bes( c d) \partCombineAutomatic | c2 f~ | f4 a,( c f | a1)~ | a2 f | f1\fermata \bar "|."
}
...
nKlarII = \transpose c bes \relative c' {
  ...
  % S. 6
  a2  a4( c) |  a2 a | bes2. bes4 | e, f g bes | a1~ | a4 a d2~ |
  % S. 7
  ...
  % S. 16
  a2( bes) | f4\p \partCombineUnisono f a\cresc c | d4. d8 c4 b | \partCombineAutomatic c2\f bes!4 a | bes( d\dim c bes) | a \partCombineUnisono c2 bes4 | a2 e |
  % S. 17
  f1\p~ | f2. r4 | \partCombineAutomatic R1*3 | e1~\p | e2 c' | d\cresc e |
  % S. 18
  f e | d d | c1\>~ | c2.\! r4 | R1*4 |
  % S. 19
  c1\f | a | c | a | bes2\p a | g a | bes\cresc a |
  % S. 20
  g a | bes a | g1 | f\f~ | f4 r r2 | R1*3 | r4 \partCombineApart f2\p( a4) |
  % S. 21
  bes4. bes8( a4 bes) | a \partCombineAutomatic f2.~ | f4 \partCombineApart bes( a bes) \partCombineAutomatic | a2 c~ | c4 f,( a c) | c1~ | c2 c | c1\fermata \bar "|."
}
...
nFagI = \relative c' {
  ...
  % S. 14
  f4 f,( a c | es) f( a c) | << { es1\sf } {s4 s2 \dim s4\!} >> | d4 bes,( d f) | \once \partCombineChords bes1\p | es2( d4 c) |
  % S. 15
  ...
  % S. 17
  \partCombineChords bes1\p~ | bes2. \partCombineAutomatic r4 | R1*3 | f'1\p~ | f2 d | c\cresc f |
  % S. 18
...
nFagII = \relative c' {
  ...
  % S. 14
  a,4 f( a c | es) f( a c) | << { ces1\sf } { s4 s2 \dim s4\!} >> | bes4 bes,( d f) | \once \partCombineChords g,1\p | as |
  % S. 15
  ...
  % S. 17
  \partCombineChords g1\p~ | g2. \partCombineAutomatic r4 | R1*3 | bes1\p~ | bes2 f | as\cresc as |
  % S. 18
