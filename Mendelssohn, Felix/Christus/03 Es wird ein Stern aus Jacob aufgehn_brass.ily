...
nHrnI = \transpose c' es \relative c' {
  ...
  % S.15
  c'1~ | c1~\cresc \partCombineAutomatic |  c4 \once \partCombineUnisono c,\f e g | c2 g | d'1 | e4( g\dim) f( e) |
  % S.16
...
nHrnII = \transpose c' es \relative c' {
  ...
  <<c1~{s2 s\dim}>> c1~ | c\! | R1 | \partCombineApart c\p~ | c~ |
  % S.15
  c1~ | c1~\cresc \partCombineAutomatic |  c4  \once \partCombineUnisono c\f e g | c2 g | c1 | c4( e\dim) d( c) |
  % S.16
...
nPosT = \relative c' {
  ...
  % S.19
  f'1\f | es | es2 d | es1 | as,2\p bes | d es | as,\cresc bes |
  % S.20
