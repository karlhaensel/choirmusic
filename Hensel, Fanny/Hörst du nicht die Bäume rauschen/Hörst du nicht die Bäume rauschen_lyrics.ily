...
tText = \lyricmode {
  ...
  und die stil -- len Bur -- gen se -- hen, in den Flulss vom ho -- hen
  
  Stein, in den Fluss vom ho -- hen \tag #'s { Stein, __ vom ho -- hen Stein. } \tag #'a \tag #'t { Stein, vom ho -- hen Stein. __ } \tag #'b { Stein. __ }
  Kennst du noch die sü -- ßen Lie -- der aus \tag #'s \tag #'t { der __ } \tag #'a \tag #'b { der } al -- ten schön -- nen
  ...
  lau -- schen, komm her -- ab, hier ists so kühl, komm her --
  ab, hier ists so \tag #'s \tag #'a \tag #'t { kühl, __ } \tag #'b { kühl, } komm her -- ab, komm her --
  ab, komm her -- ab hier ists \tag #'s { so __ } \tag #'a \tag #'t \tag #'b { so } \tag #'s \tag #'a \tag #'t { kühl. __ } \tag #'b { kühl. }
}