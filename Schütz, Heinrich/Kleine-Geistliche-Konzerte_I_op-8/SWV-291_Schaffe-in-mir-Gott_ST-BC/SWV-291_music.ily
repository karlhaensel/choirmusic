...
nSopran = \relative c'' {
  ...
  b2 g fis8([ g16 a g8 a16 b] fis16[ d e fis] g[ a b c] | d2~ d8[ c16 b] a[ g fis e] fis4 g2) fis4 | g\breve \bar "|."
}
...
nTenor = \relative c' {
  ...
  g8[ a g a] b[ c b c] d[ a b g] d'2~ | d8[ c16 b] a[ g fis e] d2. e16[ d e c] d4.) d8 | g\breve \bar "|."
}
...
nBC = \relative c' {
  ...
  g e d1~ | d2 d2. e4 d2 | g,\breve \bar "|."
}
...
nBCfigured = \figuremode {
  ...
  <_>1 <_+> | <_>2 <_+>1 <4>4 <_+> | <_>\breve \bar "|."
}
