...
nSopran = \relative c'' {
  ...
  d2 cis d4 a8 g fis d d' c! | b2 a r4 g8 f e c c' b | \noTimeSignature \time 6/2 a a d c b b e d cis4( d2 cis4) d1\fermata |
  \noTimeSignature \time 4/2 R\breve | \noTimeSignature \time 2/2 R1*2 | \noTimeSignature \time 4/2 r1 d4. d8 d4 d |
  ...
  a,2 a r e16([ f g d] e[ d e c] | \noTimeSignature \time 2/2 d8) d r4 f16([ g a e] f[ e f d] | \noTimeSignature \time 4/2 e8) e e16([ d e f] g[ f g e] f[ e f d] e8\([ f]\)) g([ f]) e4. d8 |
  
  d1 r | R\breve | r8 e fis4~( fis16[ d e fis] g4~ g16[ e f! g] a2) g8 f |
  e4( f2) e4 f a8 g f d d' c | b2 a r4 g8 f e c c' b | \noTimeSignature \time 6/2 a8 a d c b b e d 
  cis4( d2 cis4) d1\fermata | \noTimeSignature \time 4/2 a2. a4 a2 r8 a f a | g4 e r8 g d g f4 d8 f g4( a~ a g8[ f] g2) a1 |
  ...
  b2 a r4 g8 f e c c' b | a a d c b b e d cis4( d2 cis4) | d d2 c!4 bes2.( a4 | \noTimeSignature \time 6/2 g1) fis\breve \bar "|."
}
...
nTenor = \relative c' {
  ...
  e1 d2 r | r4 e'8 d c a f' e d2 c | \noTimeSignature \time 6/2 r4 f8 e d d g f e1 d1\fermata |
  \noTimeSignature \time 4/2 a4. a8 a4 a d,2 e | \noTimeSignature \time 2/2 f8([ e e d16 c] d8.[ e16] f[ g a b] | c8[ d16 e a,8 b16 c] b8.[ g16] a[ b c d] | \noTimeSignature \time 4/2 e[ f g d] e[ d e c] d8) g, c2( b8[ a] b4.) b8 |
  c1 r | R\breve | e4. e8 e4 e a,2 a4 a |
  f2 f a16([ b c g] a[ g a f] g8) g r4 | \noTimeSignature \time 2/2 b16([ c d a] b[ a b g] a8) a r4 | \noTimeSignature \time 4/2 c16([ d e b] c[ b c a] b[ a b cis] d[ c! d b] cis4) d d4. cis8 |
  
  d2 r8 a b4~( b16[ g a b] c4~ c16[ a b c] d4~ | d16[ b c d] e2) d8 c b2. b4 | a2 r r1 |
  R\breve | r4 e'8 d c a f' e d2 c | \noTimeSignature \time 6/2 r4 f8 e d d g f
  e1 d\fermata | \noTimeSignature \time 4/2 c2. c4 c1 | r8 c g c bes4 g r8 d' a d c4 a8 a | bes1 a |
  ...
  r4 e'8 d c a f' e d2 c | r4 f8 e d d g f e1 | d r4 d2 c4 | \noTimeSignature \time 6/2 bes1 a\breve \bar "|."
}
...
nBC = \relative c {
  ...
  g a d d | e f g c, | \noTimeSignature \time 6/2 d g a1 d,1\fermata |
  \noTimeSignature \time 4/2 d1 d2 cis | \noTimeSignature \time 2/2 d1 | a2 e' | \noTimeSignature \time 4/2 c g'4 e d1 |
  c2 a g1~ | g2 d' a e'4 d | e1 a,2 a4 a' |
  f1 f2 c | \noTimeSignature \time 2/2 g' d | \noTimeSignature \time 4/2 a' g4 d a' g a2 |
  
  d, d e f | g a4 d, e1 | a,2 b c d |
  c4 bes c2 f, d' | e f g c, | \noTimeSignature \time 6/2 d g
  a1 d,\fermata | \noTimeSignature \time 4/2 f,2. f4 f1 | c'2 g d' c4 a | bes1 a |
  ...
  e2 f g c, | d g a1 | d,2 bes4 a g1 | \noTimeSignature \time 6/2 g d'\breve \bar "|."
}
