...
nTenor = \relative c' {
  ...
  c8[ d16 es a,8 bes16 c] e,!16[ f e f] g[ a g a] | bes8[ c16 d g,8 a16 bes] d,[ e d e] f[ g f g] a8[ bes16 c] f,[ g a g] g2) | \noTimeSignature \time 10/2 f r4 d' c8([ bes bes a] bes[ a a g] a[ bes c bes] a2)  g\breve\fermata \bar "|."
}
...
nBC = \relative c' {
  ...
  f, c' | g bes f c' | \noTimeSignature \time 10/2 f, bes a g d'4 c d2 g,\breve\fermata \bar "|."
}
